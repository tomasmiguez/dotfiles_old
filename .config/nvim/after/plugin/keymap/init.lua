...
vnoremap('[l', "<Esc>:call NextIndent(0, 0, 0, 1)<CR>m'gv''", silent)
vnoremap(']l', "<Esc>:call NextIndent(0, 1, 0, 1)<CR>m'gv''", silent)
vnoremap('[L', "<Esc>:call NextIndent(0, 0, 1, 1)<CR>m'gv''", silent)
vnoremap(']L', "<Esc>:call NextIndent(0, 1, 1, 1)<CR>m'gv''", silent)
